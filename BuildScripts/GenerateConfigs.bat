...
echo set(NAT_COLLECT_PORTS_PER_SAMPLE 200) # Total amount of ports requested during collection step >> ..\android.config
echo set(NAT_COLLECT_SAMPLE_DELAY_MS 30000) # Delay between two consecutive NAT collection steps >> ..\android.config
